...
function formataCnpjCpf(campo, evt) {
...
function formataporcento(campo, evt) {
    //100,00%
    var xPos = PosicaoCursor(campo);
    evt = getEvent(evt);
    var tecla = getKeyCode(evt);
    if (tecla === 8 && !campo.value.includes("%")) {
        campo.value = campo.value + "%";
        MovimentaCursor(campo, campo.value.length - 1);
    }
    if (tecla === 39) {
        MovimentaCursor(campo, campo.value.length - 1);
    }
    ...
    vr = campo.value = filtraNumerosComVirgula(campo.value);
...
function formatainscricaoestadual(campo, evt) {
    ...
    if (tam >= 3 && tam < 6)
        ...
        campo.value = vr.substr(0, 3) + '.' + vr.substr(3, 3) + '.' + vr.substr(6, 3) + '/' + vr.substr(9,4);
    MovimentaCursor(campo, xPos);
}
...
function formataDataAnoMes(campo, evt) {
    var xPos = PosicaoCursor(campo);
    //dd/MM/yyyy
    evt = getEvent(evt);
    ...
    if (tam >= 2 && tam < 4)
        campo.value = vr.substr(0, 2) + '/' + vr.substr(4);
    if (tam == 4)
...
function formataRG(campo, evt) {
    ...
    if (tam >= 2 && tam < 5)
        ...
        campo.value = vr.substr(0, 2) + '.' + vr.substr(3, 3) + '.' + vr.substr(5);
    else if (tam >= 7)
        campo.value = vr.substr(0, 2) + '.' + vr.substr(3, 3) + '.' + vr.substr(6, 2) + '-' + vr.substr(7);
    MovimentaCursor(campo, xPos);
}
...
function formataCevaRef(campo, evt) {
    //312555-650
    var xPos = PosicaoCursor(campo);
    evt = getEvent(evt);
    var tecla = getKeyCode(evt);
    ...
    if (tam < 3) {
        // letras = filtraCaracteres(vr.substr(0, 2));
        campo.value = filtraCaracteres(campo.value.substring(0)).toUpperCase();
    }
    else if (tam == 3) {
        campo.value = filtraCaracteres(campo.value.substring(0, 2)).toUpperCase() + filtraNumeros(campo.value.substring(2, 3));
    }
    else if (tam == 4) {
        campo.value = filtraCaracteres(campo.value.substring(0, 2)).toUpperCase() + filtraNumeros(campo.value.substring(2, 4));
    }
    else if (tam == 5) {
        campo.value = filtraCaracteres(campo.value.substring(0, 2)).toUpperCase() + filtraNumeros(campo.value.substring(2, 5));
    }
    //campo.value = vr + filtraNumeros(vr.substr(2, 3));
    else if (tam == 6)
    // campo.value = vr + '-';
    {
        campo.value = filtraCaracteres(campo.value.substring(0, 2)).toUpperCase() + filtraNumeros(campo.value.substring(2, 5)) + '-' + filtraNumeros(campo.value.substr(5, 1));
        //segundo = letras + primeiras + '-';
        //campo.value = letras + primeiras + '-';
    }
    else if (tam > 6)
        //campo.value = filtraCaracteres(vr.substr(0, 2)) + (vr.substr(1, 3)) + '-' + filtraNumeros(vr.substr(6));
        campo.value = filtraCaracteres(campo.value.substring(0, 2)).toUpperCase() + filtraNumeros(campo.value.substring(2, 5)) + '-' + filtraNumeros(campo.value.substr(6));
    MovimentaCursor(campo, xPos);
}
