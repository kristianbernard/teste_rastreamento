<%@ Page Title="" Language="VB" MasterPageFile="~/restrito/MasterPage.master" AutoEventWireup="false" CodeFile="tarefas.aspx.vb" Inherits="tarefas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <div class="panel panel-primary" style="margin-right:1rem; margin-left:1rem;">
        <div class="panel-heading">
            <center>Cadastro de Tarefas</center>
        </div>
